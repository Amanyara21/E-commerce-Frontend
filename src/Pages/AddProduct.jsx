...
//to get image from user
  ...
  //adding functionality to send data to database
  ...
  const AddProduct = async () => {
    ...
    await fetch('https://e-commerce-backend-gray.vercel.app/upload', {
      method: 'POST',
      headers: {
    ...
    if (dataObj.filename) {
      ...
      await fetch('https://e-commerce-backend-gray.vercel.app/addproduct', {
      method: 'POST',
      headers: {
        Accept:'application/json',
